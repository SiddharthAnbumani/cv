...
export default function ProjectProfile({ title, description, img, page, tag }) {
  return (
    <div className="flex justify-center items-center w-[350px] md:w-[350px] lg:w-[450px] xl:w-full md:p-10 p-1">
      <div className="flex flex-col items-center justify-center lg:h-[450px] bg-white/20 backdrop-blur-3xl rounded-3xl p-5 transition-transform duration-200 hover:scale-110 lg:w-full">
