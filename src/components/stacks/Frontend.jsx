...
export default function Frontend() {
  return (
    <div className="flex justify-center slide-right">
      <div className=" md:w-[60%] my-5 p-5 bg-black/70 md:bg-white/10 backdrop-blur-3xl text-white rounded-4xl flex flex-col items-center justify-center md:flex-row">
