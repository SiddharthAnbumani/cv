            ...
            <div className=" w-[80%] flex flex-col justify-center items-center">
                ...
                <div className="border-white border-1 my-4 px-4 py-4 rounded-2xl bg-white/10 backdrop-blur-3xl">
                   <h1 className="text-3xl mx-4 font-extrabold">
                    ...
                    <h1 className="text-2xl mx-4 font-semibold">
                        Waves Swim Academy | Chennai, India
                    </h1>
                    <h1 className="text-xl text-blue-700 font-semibold mx-4">
                        Apr 2025 – Present
                    </h1>
                    <p className="mx-4 px-4 text-justify hyphens-auto text-lg leading-6 my-4 font-light">
                ...
                <div className=" border-white border-2 my-4 px-4 py-4 rounded-2xl bg-white/10 backdrop-blur-3xl">
                    ...
                    <h1 className="text-2xl mx-4 font-semibold">
                     ...
                     <h1 className="text-xl text-blue-600 font-semibold mx-4">
                        Jan 2024 – Mar 2025

                    </h1>
                    <p className="mx-4 px-4 text-justify hyphens-auto text-lg leading-6 my-4">
